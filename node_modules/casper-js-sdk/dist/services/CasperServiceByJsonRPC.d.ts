...
import { DeployUtil, CLPublicKey, CLValue, StoredValue, Transfers } from '..';
...
export declare class CasperServiceByJsonRPC {
     ...
     */
    getDeployInfo(deployHashBase16: string, props?: RpcRequestProps): Promise<GetDeployResult>;
    /**
     ...
     */
    getBlockInfo(blockHashBase16: JsonBlockHash, props?: RpcRequestProps): Promise<GetBlockResult>;
    /**
     ...
     * @returns A `Promise` resolving to a `GetBlockResult`
     */
    getBlockInfoByHeight(height: number, props?: RpcRequestProps): Promise<GetBlockResult>;
    /**
     * Get the block info of the latest block added
     * @param props optional request props
     * @returns A `Promise` that resolves to a `GetBlockResult`
     */
    getLatestBlockInfo(props?: RpcRequestProps): Promise<GetBlockResult>;
    /**
     * Get the attached node's current peers
     * @param props optional request props
     * @returns A `Promise` that resolves to a `GetPeersResult`
     */
    getPeers(props?: RpcRequestProps): Promise<GetPeersResult>;
    /**
     * Get the status of a node
     * @param props optional request props
     * @returns A `Promise` that resolves to a `GetStatusResult`
     */
    getStatus(props?: RpcRequestProps): Promise<GetStatusResult>;
    /**
     ...
     */
    getValidatorsInfo(blockHash?: string, props?: RpcRequestProps): Promise<ValidatorsInfoResult>;
    /**
     ...
     * @returns A `Promise` that resolves to a `ValidatorsInfoResult`
     */
    getValidatorsInfoByBlockHeight(blockHeight: number, props?: RpcRequestProps): Promise<ValidatorsInfoResult>;
    /**
     ...
     */
    getAccountBalanceUrefByPublicKeyHash(stateRootHash: string, accountHash: string, props?: RpcRequestProps): Promise<string>;
    /**
     ...
     */
    getAccountBalanceUrefByPublicKey(stateRootHash: string, publicKey: CLPublicKey, props?: RpcRequestProps): Promise<string>;
    /**
     ...
     */
    getAccountBalance(stateRootHash: string, balanceUref: string, props?: RpcRequestProps): Promise<BigNumber>;
    /**
     ...
     */
    queryBalance(purseIdentifierType: PurseIdentifier, purseIdentifier: string, stateRootHash?: string, props?: RpcRequestProps): Promise<BigNumber>;
    /**
     ...
     */
    getStateRootHash(blockHashBase16?: JsonBlockHash, props?: RpcRequestProps): Promise<string>;
    /**
     ...
     */
    getBlockState(stateRootHash: string, key: string, path: string[], props?: RpcRequestProps): Promise<StoredValue>;
     ...
     */
    deploy(signedDeploy: DeployUtil.Deploy, props?: RpcRequestProps): Promise<DeployResult>;
    /**
    ...
    speculativeDeploy(signedDeploy: DeployUtil.Deploy, blockIdentifier?: string, props?: RpcRequestProps): Promise<any>;
    /**
     ...
     */
    getBlockTransfers(blockHash?: string, props?: RpcRequestProps): Promise<Transfers>;
    /**
     ...
     */
    getEraInfoBySwitchBlock(blockHash?: string, props?: RpcRequestProps): Promise<EraSummary>;
    /**
     ...
     * @returns A `Promise` resolving to an `EraSummary` containing the era information
     */
    getEraInfoBySwitchBlockHeight(height: number, props?: RpcRequestProps): Promise<EraSummary>;
    /**
     * Retrieve era summary information by block hash (if provided) or most recently added block
     * @param blockHash Hexadecimal block hash. If not provided, the last block added to the chain, known as the given node, will be used
     * @returns A `Promise` resolving to an `EraSummary` containing the era information
     */
    getEraSummary(blockHash?: string): Promise<EraSummary>;
    /**
     ...
     * @returns A `Promise` resolving to an `EraSummary` containing the era information
     */
    getEraSummaryByBlockHeight(blockHeight?: number): Promise<EraSummary>;
    /**
     ...
     */
    getDictionaryItemByURef(stateRootHash: string, dictionaryItemKey: string, seedUref: string, props?: RpcRequestProps & {
        rawData?: boolean;
    }): Promise<StoredValue>;
    /**
     ...
     * @returns A `Promise` resolving to a `StoredValue` containing the item
     */
    getDictionaryItemByName(stateRootHash: string, contractHash: string, dictionaryName: string, dictionaryItemKey: string, props?: RpcRequestProps & {
        rawData?: boolean;
    }): Promise<StoredValue>;
}
